...
import Anyswappage from './components/Table'
    ...
    <div>
      <div className={classes.roottitle}>
        <h1 className={classes.title}>
          Accounts Anyswap<span className={classes.subtitle}> Anyswap</span>
        </h1>
      ...
      <div className={classes.roottitle2}>
        <div className={classes.roottitle3}>
          ...
          <StyledLink to="/tokens/label/anyswap">
            <span className={classes.token}>Token (23)</span>
          </StyledLink>
        </div>
      </div>
      <div className={classes.roottitle2}>
