...
import TxcontractPage from './components/Table'
import { rows, columns, totaltransactions } from './data'
import TableInfo from './components/TableInfo'

function Txcontractor() {
    ...
    <div>
      <div className={classes.roottitle}>
        <h1 className={classes.title}>
          Token Tracker<span className={classes.subtitle}> Token Contract</span>
        </h1>
      ...
      <div className={classes.roottitle2}>
        <div className={classes.roottitle3}>
          ...
          <StyledLink to="/accounts/label/token-contract">
            <span className={classes.token}>Accounts (107)</span>
          </StyledLink>
        </div>
