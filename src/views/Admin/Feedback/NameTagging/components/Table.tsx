              ...
              rows.map((row: any, key: any) => {
                ...
                return (
                  <TableRow key={key}>
                    ...
                    <StyledTableCell>{row.data.comName}</StyledTableCell>
                    <StyledTableCell>{row.data.comSite}</StyledTableCell>
                    <StyledTableCell>{row.data.comment}</StyledTableCell>
                    ...
                    <StyledTableCell>
                      <div style={{ display: 'flex' }}>
                        <ViewModal
                          ...
                          selectValue={row.data.selectValue}
                          link={row.data.link}
                          nameTag={JSON.stringify(row.data.nameTag)}
                        />
