...
function GeneralInquiry({ getFeedbacks, feedbacks, totalCount, loading, error, feedbackStatus }: AccountsProps) {
  ...
  React.useEffect(() => {
    getFeedbacks(page, rowsPerPage, 1)
...
export default connect(mapStateToProps, { getFeedbacks })(GeneralInquiry)
