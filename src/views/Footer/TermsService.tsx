            ...
            <Card className={classes.content}>
                <Grid container>
                    <div className={classes.header}>
                        ...
                        <p className={classes.subTitle}>Last updated: September 1st, 2020</p>
                    </div>
                    <div className={classes.figure}>

                    </div>
                    <div className={classes.body}>
                        <div className={classes.md5}>
                            <p>
                                <strong>
                            ...
                            <p>
                                These Terms of Service and any terms expressly incorporated herein (“Terms”) apply to your access to and use of all services (our “Services”) provided by BscScan.com (“Company,” “we,” or “us”).
                            </p>
                        </div>
                        <div className={classes.md5}>
                        ...
                        <div className={classes.md5}>
                            ...
                            <p>
                                ...
                                <br />
                                (d) maintain the security of your Account by protecting your Account password and restricting access to your computer and your Account;
                                <br />
                        ...
                        <div className={classes.md5}>
                            ...
                            <p>
                                ...
                                <br />
                                (e) incorrectly constructed transactions or mistyped Binance Smart Chain addresses; or
                                <br />
                        ...
                        <div className={classes.md5}>
                            ...
                            <p>
                                <ul>
                                    ...
                                    <li>
                                        Use any <b>robot, spider, crawler, scraper</b> or other automated means or interface not provided by us to access our Services or to extract data;
                                    </li>
                                    <li>
                                        Engage in <b>Automated Data Collection (scraping)</b> unless such Automated Data Collection is confined solely to search indexing for display on the Internet;
                                    </li>
                                    <li>
                        ...
                        <div className={classes.md5}>
                            ...
                            <p>
                                7.1.<b>Responsibility for User-Generated Content</b> - You are solely responsible for the content of, and for any harm resulting from , any User-Generated Content that you post, upload, link to or otherwise make available via the Service, regardless of the form of that Content.We are not responsible for any public display or misuse of your User-Generated Content.We have the right (though not the obligation) to refuse or remove any User-Generated Content that, in our sole discretion, violates any BscScan terms or policies.
                            </p>
                            <p>
                                7.1.<b>Responsibility for User-Generated Content</b> - You are solely responsible for the content of, and for any harm resulting from , any User-Generated Content that you post, upload, link to or otherwise make available via the Service, regardless of the form of that Content.We are not responsible for any public display or misuse of your User-Generated Content.We have the right (though not the obligation) to refuse or remove any User-Generated Content that, in our sole discretion, violates any BscScan terms or policies.
                            </p>
                            <p>
                                7.3.<b>License Grant to Us</b> - We need the legal right to do things like host Your Content, publish it, and share it.You grant us and our legal successors the right to store, parse, and display your content, and make incidental copies as necessary to render the Website and provide the service.
                            </p>
                            <p>
                                7.4.<b>Moral Rights</b> - You retain all moral rights to Your Content that you upload, publish, or submit to any part of the Service, including the rights of integrity and attribution.However, you waive these rights and agree not to assert them against us, to enable us to reasonably exercise the rights granted in Section 7.3.
                            </p>
                            <p>
                                7.5.To the extent this agreement is not enforceable by applicable law, you grant BscScan the rights we need to use your content without attribution and to make reasonable adaptations of your content as necessary to render the Website and provide the service.
                            </p>
                        </div>
                        <div className={classes.md5}>
                            <h3 className={classes.bodyTitle}>
                            ...
                            <p>
                                Unauthorized use and/or duplication of this material without express and written permission from this site’s author and/or owner is strictly prohibited.Excerpts and links may be used, provided that full and clear credit is given to BscScan.com with appropriate and specific direction to the original content.
                            </p>
                        </div>
                        <div className={classes.md5}>
                            <h3 className={classes.bodyTitle}>
                            ...
                            <p>
                                “BscScan” the Company logo, and any other Company product or service names, logos or slogans that may appear on our Services are trademarks of Company and may not be copied, imitated or used, in whole or in part, without our prior written permission.
                            </p>
                            <p>
                        ...
                        <div className={classes.md5}>
                            ...
                            <p>
                                Please see our detailed <Link to="/privacyPolicy" className={classes.link}>Privacy Policy.</Link>
                            </p>
                        </div>
                        <div className={classes.md5}>
                            <h3 className={classes.bodyTitle}>
